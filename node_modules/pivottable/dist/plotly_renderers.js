(function() {
  ...
  callWithJQuery = function(pivotModule) {
    if (typeof exports === "object" && typeof module === "object") {
      return pivotModule(require("jquery"), require("plotly.js-dist"));
    } else if (typeof define === "function" && define.amd) {
      return define(["jquery", "plotly.js-dist"], pivotModule);
    } else {
  ...
  callWithJQuery(function($, Plotly) {
    ...
    makePlotlyChart = function(traceOptions, layoutOptions, transpose) {
      ...
      return function(pivotData, opts) {
        ...
        Plotly.newPlot(
          result[0],
          data,
          $.extend(layout, layoutOptions, opts.plotly),
          opts.plotlyConfig
        );
    ...
    makePlotlyScatterChart = function() {
      return function(pivotData, opts) {
        ...
        layout = {
          title:
            pivotData.rowAttrs.join("-") +
            " vs " +
            pivotData.colAttrs.join("-"),
          hovermode: "closest",
          xaxis: {
